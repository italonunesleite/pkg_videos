 ...
 * @since       3.2
 */
class VideosTableVideo extends JTable
{
	/**
	 * Constructor.
	 *
	...
	protected function _getAssetName()
	{
		...
		return 'com_videos.video.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		// This is a video under a category.
		if ($this->catid)
		{
	...
	public function check()
	{
		...
		if (trim($this->title) == '')
		{
			$this->setError(JText::_('COM_VIDEOS_ERR_TABLES_TITLE'));
	...
	/**
	 * Overload the store method for the Videos table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New video. A video created and created_by field can be set by the user,
		...
		{
			$this->setError(JText::_('COM_VIDEOS_ERROR_VIDEO_UNIQUE_ALIAS'));
